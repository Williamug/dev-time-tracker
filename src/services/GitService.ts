...
export class GitService {
  ...
  public static getInstance(backendService?: BackendService): GitService {
    if (!GitService.instance) {
      GitService.instance = new GitService(backendService);
    } else if (backendService) {
      // Update backend service reference if provided
      GitService.instance.backendService = backendService;
    }
